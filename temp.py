...
#excel_writer = pd.ExcelWriter('leaf_damage_analysis.xlsx', engine='openpyxl')
...
for image_file in image_files:
    ...
    edged = cv2.Canny(mean_shift, 190, 320)
    ...
    _, img_gray = cv2.threshold(img_gray,47,255,cv2.THRESH_BINARY)
